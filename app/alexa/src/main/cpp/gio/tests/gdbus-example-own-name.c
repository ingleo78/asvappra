...
int main(int argc, char *argv[]) {
  ...
  if (opt_replace) flags |= G_BUS_NAME_OWNER_FLAGS_REPLACE;
  if (opt_allow_replacement) flags |= G_BUS_NAME_OWNER_FLAGS_ALLOW_REPLACEMENT;
  owner_id = g_bus_own_name(G_BUS_TYPE_SESSION, opt_name, flags, on_bus_acquired, on_name_acquired, on_name_lost, NULL, NULL);
