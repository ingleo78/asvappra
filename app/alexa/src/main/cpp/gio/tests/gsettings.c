...
static void check_and_free(GVariant *value, const gchar *expected) {
  gchar *printed;
...
static void test_wrong_path(void) {
  if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) {
...
static void changed_cb(GSettings *settings, const gchar *key, gpointer data) {
...
void test_changes(void) {
  ...
  GSettings *settings2;
  settings = g_settings_new("org.gtk.test");
  g_signal_connect(settings,"changed", G_CALLBACK(changed_cb), "greeting");
...
static void changed_cb2(GSettings *settings, const gchar *key, gpointer data) {
  gboolean *p = data;
  *p = TRUE;
}
void test_delay_apply(void) {
  GSettings *settings;
  GSettings *settings2;
  gchar *str;
  settings = g_settings_new("org.gtk.test");
  ...
  g_signal_connect(settings, "changed",G_CALLBACK(changed_cb2), &changed_cb_called);
  g_signal_connect(settings2, "changed",G_CALLBACK(changed_cb2), &changed_cb_called2);
...
static void test_delay_revert(void) {
  GSettings *settings;
  GSettings *settings2;
  gchar *str;
  settings = g_settings_new("org.gtk.test");
...
static void keys_changed_cb(GSettings *settings, const GQuark *keys, gint n_keys) {
  gchar *str;
  g_assert_cmpint(n_keys, ==, 2);
  g_assert((keys[0] == g_quark_from_static_string("greeting") && keys[1] == g_quark_from_static_string("farewell")) ||
           (keys[1] == g_quark_from_static_string("greeting") && keys[0] == g_quark_from_static_string("farewell")));
  g_settings_get(settings, "greeting", "s", &str);
...
static void test_atomic(void) {
  ...
  changed_cb_called = FALSE;
  changed_cb_called2 = FALSE;
  g_signal_connect(settings2, "change-event",G_CALLBACK(keys_changed_cb), NULL);
  g_settings_delay(settings);
...
static void test_l10n_context(void) {
  GSettings *settings;
  gchar *str;
  gchar *locale;
  bindtextdomain("test", ".");
...
static void test_object_get_property(GObject *object, guint prop_id, GValue *value, GParamSpec *pspec) {
  TestObject *test_object = (TestObject*)object;
  switch(prop_id) {
      case PROP_BOOL: g_value_set_boolean(value, test_object->bool_prop); break;
      case PROP_ANTI_BOOL: g_value_set_boolean(value, test_object->anti_bool_prop); break;
      case PROP_BYTE: g_value_set_char(value, test_object->byte_prop); break;
      case PROP_UINT16: g_value_set_uint(value, test_object->uint16_prop); break;
      case PROP_INT16: g_value_set_int(value, test_object->int16_prop); break;
      case PROP_INT: g_value_set_int(value, test_object->int_prop); break;
      case PROP_UINT: g_value_set_uint(value, test_object->uint_prop); break;
      case PROP_INT64: g_value_set_int64(value, test_object->int64_prop); break;
      case PROP_UINT64: g_value_set_uint64(value, test_object->uint64_prop); break;
      case PROP_DOUBLE: g_value_set_double(value, test_object->double_prop); break;
      case PROP_STRING: g_value_set_string(value, test_object->string_prop); break;
      case PROP_NO_WRITE: g_value_set_string(value, test_object->no_write_prop); break;
      case PROP_STRV: g_value_set_boxed(value, test_object->strv_prop); break;
      case PROP_ENUM: g_value_set_enum(value, test_object->enum_prop); break;
      default: G_OBJECT_WARN_INVALID_PROPERTY_ID(object, prop_id, pspec); break;
  }
}
static void test_object_set_property(GObject *object, guint prop_id, const GValue *value, GParamSpec *pspec) {
  TestObject *test_object = (TestObject*)object;
  switch (prop_id) {
    case PROP_BOOL: test_object->bool_prop = g_value_get_boolean(value); break;
    case PROP_ANTI_BOOL: test_object->anti_bool_prop = g_value_get_boolean(value); break;
    case PROP_BYTE: test_object->byte_prop = g_value_get_char(value); break;
    case PROP_INT16: test_object->int16_prop = g_value_get_int(value); break;
    case PROP_UINT16: test_object->uint16_prop = g_value_get_uint(value); break;
    case PROP_INT: test_object->int_prop = g_value_get_int(value); break;
    case PROP_UINT: test_object->uint_prop = g_value_get_uint(value); break;
    case PROP_INT64: test_object->int64_prop = g_value_get_int64(value); break;
    case PROP_UINT64: test_object->uint64_prop = g_value_get_uint64(value); break;
    case PROP_DOUBLE: test_object->double_prop = g_value_get_double(value); break;
    case PROP_STRING:
    ...
    case PROP_STRV:
        ...
        break;
    case PROP_ENUM: test_object->enum_prop = g_value_get_enum(value); break;
    default: G_OBJECT_WARN_INVALID_PROPERTY_ID(object, prop_id, pspec); break;
  }
}
static GType test_enum_get_type(void) {
...
static void test_object_class_init(TestObjectClass *class) {
  ...
  g_object_class_install_property(gobject_class, PROP_BOOL,g_param_spec_boolean("bool", "", "", FALSE, G_PARAM_READWRITE));
  g_object_class_install_property(gobject_class, PROP_ANTI_BOOL,g_param_spec_boolean("anti-bool", "", "", FALSE, G_PARAM_READWRITE));
  g_object_class_install_property(gobject_class, PROP_BYTE,g_param_spec_char("byte", "", "", G_MININT8, G_MAXINT8, 0, G_PARAM_READWRITE));
  g_object_class_install_property(gobject_class, PROP_INT16,g_param_spec_int("int16", "", "", -G_MAXINT16, G_MAXINT16, 0, G_PARAM_READWRITE));
  g_object_class_install_property(gobject_class, PROP_UINT16,g_param_spec_uint("uint16", "", "", 0, G_MAXUINT16, 0, G_PARAM_READWRITE));
  g_object_class_install_property(gobject_class, PROP_INT,g_param_spec_int("int", "", "", G_MININT, G_MAXINT, 0, G_PARAM_READWRITE));
  g_object_class_install_property(gobject_class, PROP_UINT,g_param_spec_uint("uint", "", "", 0, G_MAXUINT, 0, G_PARAM_READWRITE));
  g_object_class_install_property(gobject_class, PROP_INT64,g_param_spec_int64("int64", "", "", G_MININT64, G_MAXINT64, 0, G_PARAM_READWRITE));
  g_object_class_install_property(gobject_class, PROP_UINT64,g_param_spec_uint64("uint64", "", "", 0, G_MAXUINT64, 0, G_PARAM_READWRITE));
  g_object_class_install_property(gobject_class, PROP_DOUBLE,g_param_spec_double("double", "", "", -G_MAXDOUBLE, G_MAXDOUBLE, 0.0, G_PARAM_READWRITE));
  g_object_class_install_property(gobject_class, PROP_STRING,g_param_spec_string("string", "", "", NULL, G_PARAM_READWRITE));
  g_object_class_install_property(gobject_class, PROP_NO_WRITE,g_param_spec_string("no-write", "", "", NULL, G_PARAM_READABLE));
  g_object_class_install_property(gobject_class, PROP_NO_READ, g_param_spec_string ("no-read", "", "", NULL, G_PARAM_WRITABLE));
  g_object_class_install_property(gobject_class, PROP_STRV, g_param_spec_boxed("strv", "", "", G_TYPE_STRV, G_PARAM_READWRITE));
  g_object_class_install_property(gobject_class, PROP_ENUM, g_param_spec_enum("enum", "", "", test_enum_get_type(), TEST_ENUM_FOO, G_PARAM_READWRITE));
}
static TestObject *test_object_new(void) {
  return (TestObject*)g_object_new(test_object_get_type(), NULL);
}
static void test_simple_binding(void) {
  TestObject *obj;
  GSettings *settings;
  gboolean b;
  gchar y;
  ...
  g_settings_bind(settings, "anti-bool", obj, "anti-bool", G_SETTINGS_BIND_INVERT_BOOLEAN);
...
static void test_bind_writable(void) {
  TestObject *obj;
  GSettings *settings;
  gboolean b;
  settings = g_settings_new("org.gtk.test.binding");
...
static void test_directional_binding(void) {
  TestObject *obj;
  GSettings *settings;
  gboolean b;
  gint i;
...
static void test_typesafe_binding(void) {
  if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) {
      TestObject *obj;
      GSettings *settings;
      settings = g_settings_new("org.gtk.test.binding");
...
static gboolean string_to_bool(GValue *value, GVariant *variant, gpointer user_data) {
  const gchar *s;
  s = g_variant_get_string (variant, NULL);
  g_value_set_boolean (value, g_strcmp0 (s, "true") == 0);
  return TRUE;
}
static GVariant *bool_to_string(const GValue *value, const GVariantType *expected_type, gpointer user_data) {
  if (g_value_get_boolean(value)) return g_variant_new_string("true");
  else return g_variant_new_string("false");
}
static void test_custom_binding(void) {
  TestObject *obj;
  GSettings *settings;
  gchar *s;
  gboolean b;
  ...
  g_settings_bind_with_mapping(settings, "string", obj, "bool",G_SETTINGS_BIND_DEFAULT, string_to_bool, bool_to_string,NULL, NULL);
...
static void test_no_change_binding(void) {
  TestObject *obj;
  GSettings *settings;
  gboolean b;
  settings = g_settings_new("org.gtk.test.binding");
...
static void test_no_read_binding(void) {
  if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) {
      TestObject *obj;
      GSettings *settings;
      settings = g_settings_new("org.gtk.test.binding");
...
static void test_no_write_binding(void) {
  if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) {
      TestObject *obj;
      GSettings *settings;
      settings = g_settings_new("org.gtk.test.binding");
...
static void test_child_schema(void) {
  GSettings *settings;
  GSettings *child;
  guint8 byte;
  settings = g_settings_new("org.gtk.test.basic-types");
...
static gboolean glib_translations_work(void) {
  gchar *locale;
  gchar *orig = "Unnamed";
  gchar *str;
  locale = g_strdup(setlocale(LC_MESSAGES, NULL));
...
#include "../strinfo.c"
static void test_strinfo(void) {
  gchar array[] = "\1\0\0\0\xff""foo""\0\0\0\xff\2\0\0\0\xff""bar""\0\0\0\xff\3\0\0\0\xfe""baz""\0\0\0\xff";
  ...
  g_assert_cmpstr(strinfo_string_from_alias(strinfo, length, "foo"), ==, NULL);
  g_assert_cmpstr(strinfo_string_from_alias(strinfo, length, "bar"), ==, NULL);
  g_assert_cmpstr(strinfo_string_from_alias(strinfo, length, "baz"), ==, "bar");
  g_assert_cmpstr(strinfo_string_from_alias(strinfo, length, "quux"), ==, NULL);
...
static void test_enums(void) {
  ...
  if (!backend_set) {
      if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) g_settings_get_enum(direct, "test");
      g_test_trap_assert_failed();
      g_test_trap_assert_stderr("*not associated with an enum*");
      if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) g_settings_set_enum(settings, "test", 42);
      g_test_trap_assert_failed();
      g_test_trap_assert_stderr("*invalid enum value 42*");
      if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) g_settings_set_string(settings, "test", "qux");
      g_test_trap_assert_failed();
      g_test_trap_assert_stderr("*g_settings_set_value*valid range*");
      if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) g_settings_get_flags(settings, "test");
      g_test_trap_assert_failed();
...
static void test_flags(void) {
  ...
  direct = g_settings_new("org.gtk.test.enums.direct");
  if (!backend_set) {
      if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) g_settings_get_flags (direct, "test");
      g_test_trap_assert_failed();
      g_test_trap_assert_stderr("*not associated with a flags*");
      if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) g_settings_set_flags (settings, "f-test", 0x42);
      g_test_trap_assert_failed();
      g_test_trap_assert_stderr("*invalid flags value 0x00000042*");
      if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) {
          g_settings_set_strv(settings, "f-test",(const gchar**)g_strsplit ("rock", ",", 0));
      }
      g_test_trap_assert_failed();
      g_test_trap_assert_stderr("*g_settings_set_value*valid range*");
      if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) g_settings_get_enum(settings, "f-test");
      g_test_trap_assert_failed();
      g_test_trap_assert_stderr("*not associated with an enum*");
  }
  ...
  g_strfreev(strv);
  g_free(str);
  g_settings_set_flags(settings, "f-test", TEST_FLAGS_WALKING | TEST_FLAGS_TALKING);
  strv = g_settings_get_strv(settings, "f-test");
  str = g_strjoinv(",", strv);
  g_assert_cmpstr(str, ==, "talking,walking");
  g_strfreev(strv);
  g_free(str);
  g_assert_cmpint(g_settings_get_flags(settings, "f-test"), ==,TEST_FLAGS_WALKING | TEST_FLAGS_TALKING);
  ...
  g_strfreev(strv);
  g_free(str);
  g_assert_cmpint(g_settings_get_flags(settings, "f-test"), ==,TEST_FLAGS_TALKING | TEST_FLAGS_LAUGHING);
}
static void test_range(void) {
  ...
  if (!backend_set) {
      if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) g_settings_set_int(settings, "val", 45);
      g_test_trap_assert_failed();
      g_test_trap_assert_stderr("*g_settings_set_value*valid range*");
      if (g_test_trap_fork(0, G_TEST_TRAP_SILENCE_STDERR)) g_settings_set_int(settings, "val", 1);
      g_test_trap_assert_failed();
      g_test_trap_assert_stderr("*g_settings_set_value*valid range*");
  }
...
static gboolean strv_has_string(gchar **haystack, const gchar *needle) {
  guint n;
...
static gboolean strv_set_equal(gchar **strv, ...) {
  gint count;
  va_list list;
  const gchar *str;
  gboolean res;
  ...
  va_end(list);
  if (res) res = g_strv_length((gchar**)strv) == count;
  return res;
}
...
static void test_list_schemas(void) {
  ...
  g_assert(strv_set_equal((gchar**)relocs, "org.gtk.test.no-path", NULL));
  g_assert(strv_set_equal((gchar**)schemas, "org.gtk.test", "org.gtk.test.basic-types", "org.gtk.test.complex-types", "org.gtk.test.localized",
           "org.gtk.test.binding", "org.gtk.test.enums", "org.gtk.test.enums.direct", "org.gtk.test.range", "org.gtk.test.range.direct", "org.gtk.test.mapped",
           NULL));
}
static gboolean map_func(GVariant *value, gpointer *result, gpointer user_data) {
  gint *state = user_data;
  gint v;
  if (value) v = g_variant_get_int32(value);
  else v = -1;
  if (*state == 0) {
      g_assert_cmpint(v, ==, 1);
      (*state)++;
...
static void test_get_mapped(void) {
  GSettings *settings;
  gint state;
  gpointer p;
  gint val;
...
static void test_get_range(void) {
  ...
  check_and_free(range, "('flags', <['mourning', 'laughing', 'talking', 'walking']>)");
  g_object_unref(settings);
  settings = g_settings_new("org.gtk.test");
...
int main(int argc, char *argv[]) {
  ...
  if (!backend_set) g_setenv("GSETTINGS_BACKEND", "memory", TRUE);
  g_type_init();
  g_test_init(&argc, &argv, NULL);
  g_remove("org.gtk.test.enums.xml");
  //g_assert(g_spawn_command_line_sync("../../gobject/glib-mkenums --template " SRCDIR "/enums.xml.template " SRCDIR "/testenum.h", &enums, NULL, &result, NULL));
  g_assert(result == 0);
  g_assert(g_file_set_contents("org.gtk.test.enums.xml", enums, -1, NULL));
  g_free(enums);
  g_remove("gschemas.compiled");
  //g_assert(g_spawn_command_line_sync("../glib-compile-schemas --targetdir=. --schema-file=org.gtk.test.enums.xml --schema-file=" SRCDIR "/org.gtk.test.gschema.xml", NULL, NULL, &result, NULL));
  g_assert(result == 0);
