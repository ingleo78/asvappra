...
GType g_app_info_create_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GAppInfoCreateFlags"), values);
...
GType g_converter_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GConverterFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_converter_result_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GConverterResult"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_data_stream_byte_order_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GDataStreamByteOrder"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_data_stream_newline_type_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GDataStreamNewlineType"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_file_attribute_type_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GFileAttributeType"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_file_attribute_info_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GFileAttributeInfoFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_file_attribute_status_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GFileAttributeStatus"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_file_query_info_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GFileQueryInfoFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_file_create_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GFileCreateFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_file_measure_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        static const GFlagsValue values[] = {
            { 0, "G_FILE_MEASURE_NONE", "none" },
            { 2, "G_FILE_MEASURE_REPORT_ANY_ERROR", "report-any-error" },
            { 4, "G_FILE_MEASURE_APPARENT_SIZE", "apparent-size" },
            { 8, "G_FILE_MEASURE_NO_XDEV", "no-xdev" },
            { 0, NULL, NULL }
        };
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GFileMeasureFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_mount_mount_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GMountMountFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_mount_unmount_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GMountUnmountFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_drive_start_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GDriveStartFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_drive_start_stop_type_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GDriveStartStopType"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_file_copy_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GFileCopyFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_file_monitor_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GFileMonitorFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_file_type_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GFileType"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_filesystem_preview_type_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GFilesystemPreviewType"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_file_monitor_event_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GFileMonitorEvent"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_io_error_enum_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        static const GEnumValue values[] = {
            ...
            { 44, "G_IO_ERROR_BROKEN_PIPE", "broken-pipe" },
            { 44, "G_IO_ERROR_CONNECTION_CLOSED", "connection-closed" },
            { 45, "G_IO_ERROR_NOT_CONNECTED", "not-connected" },
            { 46, "G_IO_ERROR_MESSAGE_TOO_LARGE", "message-too-large" },
            { 0, NULL, NULL }
        };
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GIOErrorEnum"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_ask_password_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        static const GFlagsValue values[] = {
            ...
            { 32, "G_ASK_PASSWORD_TCRYPT", "tcrypt" },
            { 0, NULL, NULL }
        };
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GAskPasswordFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_password_save_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GPasswordSave"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_mount_operation_result_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GMountOperationResult"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_output_stream_splice_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GOutputStreamSpliceFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_io_stream_splice_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GIOStreamSpliceFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_emblem_origin_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GEmblemOrigin"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_resolver_error_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GResolverError"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_resolver_record_type_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        static const GEnumValue values[] = {
            { 1, "G_RESOLVER_RECORD_SRV", "srv" },
            { 2, "G_RESOLVER_RECORD_MX", "mx" },
            { 3, "G_RESOLVER_RECORD_TXT", "txt" },
            { 4, "G_RESOLVER_RECORD_SOA", "soa" },
            { 5, "G_RESOLVER_RECORD_NS", "ns" },
            { 0, NULL, NULL }
        };
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GResolverRecordType"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_resource_error_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        static const GEnumValue values[] = {
            { 0, "G_RESOURCE_ERROR_NOT_FOUND", "not-found" },
            { 2, "G_RESOURCE_ERROR_INTERNAL", "internal" },
            { 0, NULL, NULL }
        };
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GResourceError"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_resource_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        static const GFlagsValue values[] = {
            { 0, "G_RESOURCE_FLAGS_NONE", "none" },
            { 1, "G_RESOURCE_FLAGS_COMPRESSED", "compressed" },
            { 0, NULL, NULL }
        };
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GResourceFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_resource_lookup_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        static const GFlagsValue values[] = {
            { 0, "G_RESOURCE_LOOKUP_FLAGS_NONE", "none" },
            { 0, NULL, NULL }
        };
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GResourceLookupFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_socket_family_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GSocketFamily"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_socket_type_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GSocketType"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_socket_msg_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GSocketMsgFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_socket_protocol_get_type (void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GSocketProtocol"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_zlib_compressor_format_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GZlibCompressorFormat"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_unix_socket_address_type_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GUnixSocketAddressType"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_bus_type_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GBusType"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_bus_name_owner_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GBusNameOwnerFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_bus_name_watcher_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GBusNameWatcherFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_proxy_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GDBusProxyFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_error_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GDBusError"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_connection_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GDBusConnectionFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_capability_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GDBusCapabilityFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_call_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static (g_intern_static_string ("GDBusCallFlags"), values);
        g_once_init_leave (&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_message_type_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GDBusMessageType"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_message_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GDBusMessageFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_message_header_field_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GDBusMessageHeaderField"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_property_info_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GDBusPropertyInfoFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_subtree_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GDBusSubtreeFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_server_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GDBusServerFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_signal_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GDBusSignalFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_send_message_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GDBusSendMessageFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_credentials_type_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GCredentialsType"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_message_byte_order_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GDBusMessageByteOrder"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_application_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GApplicationFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_tls_error_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GTlsError"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_tls_certificate_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GTlsCertificateFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_tls_authentication_mode_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GTlsAuthenticationMode"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_tls_rehandshake_mode_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GTlsRehandshakeMode"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_tls_password_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GTlsPasswordFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_tls_interaction_result_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GTlsInteractionResult"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_interface_skeleton_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GDBusInterfaceSkeletonFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_dbus_object_manager_client_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GDBusObjectManagerClientFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_tls_database_verify_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GTlsDatabaseVerifyFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_tls_database_lookup_flags_get_type(void) {
    ...
    if (g_once_init_enter (&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GTlsDatabaseLookupFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_tls_certificate_request_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GTlsCertificateRequestFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_io_module_scope_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GIOModuleScopeFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_socket_client_event_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GSocketClientEvent"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_socket_listener_event_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GSocketListenerEvent"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_test_dbus_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GTestDBusFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_subprocess_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GSubprocessFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_notification_priority_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GNotificationPriority"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_network_connectivity_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GNetworkConnectivity"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_pollable_return_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GPollableReturn"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_memory_monitor_warning_level_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_enum_register_static(g_intern_static_string("GMemoryMonitorWarningLevel"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_resolver_name_lookup_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GResolverNameLookupFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}
GType g_settings_bind_flags_get_type(void) {
    ...
    if (g_once_init_enter(&g_define_type_id__volatile)) {
        ...
        GType g_define_type_id = g_flags_register_static(g_intern_static_string("GSettingsBindFlags"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
    return g_define_type_id__volatile;
}