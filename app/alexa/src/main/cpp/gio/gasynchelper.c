...
static gboolean fd_source_closure_callback(int fd, GIOCondition condition, gpointer data) {
...
static void fd_source_closure_marshal(GClosure *closure, GValue *return_value, guint n_param_values, const GValue *param_values, gpointer invocation_hint,
  ...
  v_return = callback(g_value_get_int(param_values), g_value_get_flags(param_values + 1), closure->data);
