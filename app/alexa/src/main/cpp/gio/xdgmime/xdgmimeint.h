...
#define SWAP_BE32_TO_LE32(val)  (xdg_uint32_t)((((xdg_uint32_t)(val) & 0xFF000000U) >> 24) |	(((xdg_uint32_t)(val) & 0x00FF0000U) >> 8) | \
					      		 (((xdg_uint32_t)(val) & 0x0000FF00U) << 8) | (((xdg_uint32_t)(val) & 0x000000FFU) << 24))
