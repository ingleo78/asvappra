...
static void test_type_qdata(void) {
    gchar *data;
...
static void test_type_query(void) {
    GTypeQuery query;
...
G_DEFINE_TYPE_WITH_CODE(MyObject, my_object, G_TYPE_OBJECT, g_type_add_class_private (g_define_type_id, sizeof(MyObjectClassPrivate)));
static void my_object_init (MyObject *obj) {
    obj->count = 42;
}
static void my_object_class_init (MyObjectClass *klass) {}
static void test_class_private(void) {
    GObject *obj;
    MyObjectClass *class;
...
static void test_object_value(void) {
    GObject *v;
    GObject *v2;
    GValue value = { 0, };
...
static void test_initially_unowned(void) {
    GObject *obj;
...
static void test_weak_pointer(void) {
    GObject *obj;
    gpointer weak;
    gpointer weak2;
