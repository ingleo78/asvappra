...
static gpointer my_boxed_copy(gpointer orig) {
    MyBoxed *a = orig;
    MyBoxed *b;
...
static void my_boxed_free(gpointer orig) {
    MyBoxed *a = orig;
    g_free(a->bla);
...
static void test_define_boxed (void) {
    MyBoxed a;
    MyBoxed *b;
    a.ivalue = 20;
    a.bla = g_strdup("bla");
...
static void test_boxed_ownership(void) {
    GValue value = { 0, };
...
static void my_closure_notify(gpointer user_data, GClosure *closure) {
    destroy_count++;
}
static void test_boxed_closure(void) {
    GClosure *closure;
    GClosure *closure2;
    GValue value = { 0, };
...
static void test_boxed_date(void) {
    GDate *date;
    GDate *date2;
    GValue value = { 0, };
...
static void test_boxed_value (void) {
    GValue value1 = { 0, };
    GValue *value2;
    GValue value = { 0, };
...
static void test_boxed_string(void) {
    GString *v;
    GString *v2;
    GValue value = { 0, };
...
static void test_boxed_hashtable(void) {
    GHashTable *v;
    GHashTable *v2;
    GValue value = { 0, };
...
static void test_boxed_array(void) {
    GArray *v;
    GArray *v2;
    GValue value = { 0, };
...
static void test_boxed_ptrarray(void) {
    GPtrArray *v;
    GPtrArray *v2;
    GValue value = { 0, };
...
static void test_boxed_regex(void) {
    GRegex *v;
    GRegex *v2;
    GValue value = { 0, };
...
static void test_boxed_datetime(void) {
    GDateTime *v;
    GDateTime *v2;
    GValue value = { 0, };
...
static void test_boxed_error(void) {
    GError *v;
    GError *v2;
    GValue value = { 0, };
    g_value_init(&value, G_TYPE_ERROR);
    g_assert(G_VALUE_HOLDS_BOXED(&value));
    v = g_error_new_literal(G_VARIANT_PARSE_ERROR,G_VARIANT_PARSE_ERROR_NUMBER_TOO_BIG,"Too damn big");
    g_value_take_boxed(&value, v);
    v2 = g_value_get_boxed(&value);
    g_assert(v2 == v);
    v2 = g_value_dup_boxed(&value);
