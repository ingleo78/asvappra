...
#define RAPIDJSON_VERSION_CODE(x,y,z) (((x)*100000) + ((y)*100) + (z))
    ...
    #define RAPIDJSON_DIAG_POP
          ...
          (defined(_MSC_VER) && _MSC_VER >= 1600) || (defined(__SUNPRO_CC) && __SUNPRO_CC >= 0x5140 && defined(__GXX_EXPERIMENTAL_CXX0X__))
        #define RAPIDJSON_HAS_CXX11_RVALUE_REFS 1
    #else
        #define RAPIDJSON_HAS_CXX11_RVALUE_REFS 0
    #endif
        ...
        #define RAPIDJSON_HAS_CXX11_NOEXCEPT __has_feature(cxx_noexcept)
          ...
          (defined(_MSC_VER) && _MSC_VER >= 1900) || (defined(__SUNPRO_CC) && __SUNPRO_CC >= 0x5140 && defined(__GXX_EXPERIMENTAL_CXX0X__))
    ...
    #elif (defined(RAPIDJSON_GNUC) && (RAPIDJSON_GNUC >= RAPIDJSON_VERSION_CODE(4,6,0)) && defined(__GXX_EXPERIMENTAL_CXX0X__)) || \
          (defined(_MSC_VER) && _MSC_VER >= 1700) || (defined(__SUNPRO_CC) && __SUNPRO_CC >= 0x5140 && defined(__GXX_EXPERIMENTAL_CXX0X__))
