...
static void test_utf8_strncpy(void) {
  const gchar *string = "\xe2\x82\xa0gh\xe2\x82\xa4jl";
  gchar dest[20];
...
static void test_utf8_strrchr(void) {
...
static void test_utf8_reverse(void) {
  gchar *r;
...
static void test_unichar_validate(void) {
...
static void test_unichar_character_type(void) {
  gint i;
  struct {
    GUnicodeType type;
    gunichar     c;
...
static void test_unichar_break_type(void) {
  gint i;
  struct {
...
static void test_unichar_script(void) {
  gint i;
  struct {
