...
static void test_quark_basic(void) {
  GQuark quark;
...
static void test_quark_string(void) {
...
static void test_dataset_basic(void) {
...
static void test_dataset_full(void) {
...
static void foreach(GQuark   id, gpointer data, gpointer user_data) {
  gint *counter = user_data;
  *counter += 1;
}
static void test_dataset_foreach(void) {
...
static void test_dataset_destroy(void) {
...
static void test_dataset_id(void) {
