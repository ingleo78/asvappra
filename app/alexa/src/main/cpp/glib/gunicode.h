...
int g_get_charset (G_CONST_RETURN char **charset);
int g_unichar_isalnum(gunichar c) G_GNUC_CONST;
int g_unichar_isalpha(gunichar c) G_GNUC_CONST;
int g_unichar_iscntrl(gunichar c) G_GNUC_CONST;
int g_unichar_isdigit(gunichar c) G_GNUC_CONST;
int g_unichar_isgraph(gunichar c) G_GNUC_CONST;
int g_unichar_islower(gunichar c) G_GNUC_CONST;
int g_unichar_isprint(gunichar c) G_GNUC_CONST;
int g_unichar_ispunct(gunichar c) G_GNUC_CONST;
int g_unichar_isspace(gunichar c) G_GNUC_CONST;
int g_unichar_isupper(gunichar c) G_GNUC_CONST;
int g_unichar_isxdigit(gunichar c) G_GNUC_CONST;
int g_unichar_istitle(gunichar c) G_GNUC_CONST;
int g_unichar_isdefined(gunichar c) G_GNUC_CONST;
int g_unichar_iswide(gunichar c) G_GNUC_CONST;
int g_unichar_iswide_cjk(gunichar c) G_GNUC_CONST;
int g_unichar_iszerowidth(gunichar c) G_GNUC_CONST;
int g_unichar_ismark(gunichar c) G_GNUC_CONST;
...
extern const gchar g_utf8_skip_data[256];
extern const gchar* const g_utf8_skip;
#define g_utf8_next_char(p) (char*)((p) + g_utf8_skip_data[*(const guchar*)(p)])
...
int g_utf8_validate(const gchar *str, gssize max_len, const gchar **end);
int g_unichar_validate (gunichar ch) G_GNUC_CONST;
...
int g_unichar_get_mirror_char(gunichar ch, gunichar *mirrored_ch);
