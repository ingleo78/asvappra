...
_DBUS_GNUC_WARN_UNUSED_RESULT TestMainContext *test_main_context_get(void);
_DBUS_GNUC_WARN_UNUSED_RESULT TestMainContext *test_main_context_try_get(void);
...
_DBUS_GNUC_WARN_UNUSED_RESULT dbus_bool_t test_connection_try_setup(TestMainContext *ctx, DBusConnection *connection);
...
_DBUS_GNUC_WARN_UNUSED_RESULT dbus_bool_t test_server_try_setup(TestMainContext *ctx, DBusServer *server);
