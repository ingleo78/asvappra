...
#else
#define DBUS_UINT16_SWAP_LE_BE_CONSTANT(val)  ((dbus_uint16_t)((dbus_uint16_t)((dbus_uint16_t)(val) >> 8) | (dbus_uint16_t)((dbus_uint16_t)(val) << 8)))
#define DBUS_UINT32_SWAP_LE_BE_CONSTANT(val)  ((dbus_uint32_t) ((((dbus_uint32_t)(val) & (dbus_uint32_t)0x000000ffU) << 24) |     \
                                               (((dbus_uint32_t)(val) & (dbus_uint32_t)0x0000ff00U) <<  8) | (((dbus_uint32_t)(val) & (dbus_uint32_t)0x00ff0000U) >>  8) |     \
                                               (((dbus_uint32_t)(val) & (dbus_uint32_t)0xff000000U) >> 24)))
#endif
#ifdef HAVE_BYTESWAP_H
#define DBUS_UINT64_SWAP_LE_BE_CONSTANT(val) bswap_64(val)
#else
#define DBUS_UINT64_SWAP_LE_BE_CONSTANT(val)  ((dbus_uint64_t)((((dbus_uint64_t) (val) & (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x00000000000000ff)) << 56) |    \
                                               (((dbus_uint64_t)(val) & (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x000000000000ff00)) << 40) | (((dbus_uint64_t)(val) & \
                                               (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x0000000000ff0000)) << 24) | (((dbus_uint64_t)(val) & \
                                               (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x00000000ff000000)) <<  8) | (((dbus_uint64_t)(val) & \
                                               (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x000000ff00000000)) >>  8) | (((dbus_uint64_t)(val) & \
                                               (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x0000ff0000000000)) >> 24) | (((dbus_uint64_t)(val) & \
                                               (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x00ff000000000000)) >> 40) | (((dbus_uint64_t)(val) & \
...
#define _dbus_unpack_uint16(byte_order, data)  (((byte_order) == DBUS_LITTLE_ENDIAN) ? DBUS_UINT16_FROM_LE(*(dbus_uint16_t*)(data)) :    \
                                                DBUS_UINT16_FROM_BE(*(dbus_uint16_t*)(data)))
#define _dbus_unpack_uint32(byte_order, data)  (((byte_order) == DBUS_LITTLE_ENDIAN) ? DBUS_UINT32_FROM_LE (*(dbus_uint32_t*)(data)) :    \
