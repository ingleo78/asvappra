...
namespace testing {
    namespace internal {
        ...
        #define GTEST_DEATH_TEST_(statement, predicate, regex, fail) \
            ...
            } else GTEST_CONCAT_TOKEN_(gtest_label_, __LINE__): fail(::testing::internal::DeathTest::LastMessage())
        ...
        public:
            InternalRunDeathTestFlag(const std::string& a_file, int a_line, int an_index, int a_write_fd) : file_(a_file), line_(a_line),
                                     index_(an_index), write_fd_(a_write_fd) {}
