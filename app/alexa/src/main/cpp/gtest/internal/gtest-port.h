...
#endif
#endif
#if GTEST_LANG_CXX11 && (!defined(__GLIBCXX__) || (__GLIBCXX__ >= 20110325ul && __GLIBCXX__ != 20110416ul && __GLIBCXX__ != 20120313ul && \
    __GLIBCXX__ != 20110428ul && __GLIBCXX__ != 20120702ul))
...
#endif
#endif
#if (GTEST_OS_LINUX || GTEST_OS_CYGWIN || GTEST_OS_SOLARIS || (GTEST_OS_MAC && !GTEST_OS_IOS) || (GTEST_OS_WINDOWS_DESKTOP && _MSC_VER >= 1400) || \
     GTEST_OS_WINDOWS_MINGW || GTEST_OS_AIX || GTEST_OS_HPUX || GTEST_OS_OPENBSD || GTEST_OS_QNX || GTEST_OS_FREEBSD)
...
#endif
#define GTEST_IS_THREADSAFE  (GTEST_HAS_MUTEX_AND_THREAD_LOCAL_ || (GTEST_OS_WINDOWS && !GTEST_OS_WINDOWS_PHONE && !GTEST_OS_WINDOWS_RT) || \
                              GTEST_HAS_PTHREAD)
#endif
#ifdef _MSC_VER
...
namespace testing {
    ...
    namespace internal {
        ...
        #define GTEST_COMPILE_ASSERT_(expr, msg) typedef ::testing::internal::CompileAssert<(static_cast<bool>(expr))> \
        ...
        public:
            ...
            void reset(T* p = NULL) {
                if (p != ptr_) {
                    if (IsTrue(sizeof(T) > 0)) delete ptr_;
                    ptr_ = p;
                }
            }
        ...
        template<typename To, typename From>  inline To DownCast_(From* f) {
    ...
    // Nothing to do here.
        ...
        public:
            ...
            ThreadWithParam(UserThreadFunc* func, T param, Notification* thread_can_start) : func_(func), param_(param),
                            thread_can_start_(thread_can_start), finished_(false) {
    ...
    // Nothing to do here.
        ...
        #efine GTEST_DECLARE_STATIC_MUTEX_(mutex)  extern ::testing::internal::Mutex mutex
