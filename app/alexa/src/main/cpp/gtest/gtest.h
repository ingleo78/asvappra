...
namespace testing {
    ...
    public:
        ...
        template <typename T> explicit AssertionResult(const T& success, typename internal::EnableIf<!internal::ImplicitlyConvertible<T, AssertionResult>::value>::type* = NULL) :
                                     success_(success) {}
    ...
    private:
        ...
        friend TestInfo* internal::MakeAndRegisterTestInfo(const char* test_case_name, const char* name, const char* type_param, const char* value_param,
        ...
        TestInfo(const std::string& test_case_name, const std::string& name, const char* a_type_param, const char* a_value_param,
    ...
    namespace internal {
        ...
        public:
            template <typename T1, typename T2> static AssertionResult Compare(const char* lhs_expression, const char* rhs_expression, const T1& lhs, const T2& rhs) {
        ...
        public:
            ...
            template <typename T> static AssertionResult Compare(const char* lhs_expression, const char* rhs_expression, Secret*, T* rhs) {
        ...
        template <typename T1, typename T2> AssertionResult CmpHelper##op_name(const char* expr1, const char* expr2, const T1& val1, const T2& val2) {\
            ...
            else return CmpHelperOpFailure(expr1, expr2, val1, val2, #op);\
        }\
