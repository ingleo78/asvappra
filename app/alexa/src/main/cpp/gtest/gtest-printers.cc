    ...
    namespace {
        ...
        void PrintBytesInObjectToImpl(const unsigned char* obj_bytes, size_t count, ostream* os) {
            *os << count << "-byte object <";
            ...
            if (count < kThreshold) PrintByteSegmentInObjectTo(obj_bytes, 0, count, os);
            else {
    ...
    namespace internal {
        ...
        template <typename UnsignedChar, typename Char> void PrintCharAndCodeTo(Char c, ostream* os) {
            ...
            *os << " (" << static_cast<int>(c);
            ...
            else *os << ", 0x" << String::FormatHexInt(static_cast<UnsignedChar>(c));
            *os << ")";
        }
        ...
        template <typename CharType> GTEST_ATTRIBUTE_NO_SANITIZE_MEMORY_ GTEST_ATTRIBUTE_NO_SANITIZE_ADDRESS_ GTEST_ATTRIBUTE_NO_SANITIZE_THREAD_
        static void PrintCharsAsStringTo(const CharType* begin, size_t len, ostream* os) {
            ...
            *os << kQuoteBegin;
            ...
            for (size_t index = 0; index < len; ++index) {
                ...
                if (is_previous_hex && IsXDigit(cur)) *os << "\" " << kQuoteBegin;
