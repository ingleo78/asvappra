...
namespace testing {
    namespace gmock_generated_function_mockers_test {
        ...
        public:
            ...
            virtual void VoidReturning(int x);
            virtual int Nullary();
            virtual bool Unary(int x);
            virtual long Binary(short x, int y);
            virtual int Decimal(bool b, char c, short d, int e, long f, float g, double h, unsigned i, char* j, const string& k);
            virtual bool TakesNonConstReference(int& n);
            virtual string TakesConstReference(const int& n);
        #ifdef GMOCK_ALLOWS_CONST_PARAM_FUNCTIONS
            virtual bool TakesConst(const int x);
        #endif
            virtual int OverloadedOnArgumentNumber();
            virtual int OverloadedOnArgumentNumber(int n);
            virtual int OverloadedOnArgumentType(int n);
            virtual char OverloadedOnArgumentType(char c) ;
            virtual int OverloadedOnConstness();
            virtual char OverloadedOnConstness() const;
            virtual int TypeWithHole(int (*func)());
            virtual int TypeWithComma(const std::map<int, string>& a_map);
        #if GTEST_OS_WINDOWS
            STDMETHOD_(int, CTNullary)();
            STDMETHOD_(bool, CTUnary)(int x);
            STDMETHOD_(int, CTDecimal)(bool b, char c, short d, int e, long f, float g, double h, unsigned i, char* j, const string& k);
            STDMETHOD_(char, CTConst)(int x) const;
        #endif
        };
    #ifdef _MSC_VER
        #pragma warning(push)
        ...
        public:
            ...
            MOCK_METHOD10_WITH_CALLTYPE(STDMETHODCALLTYPE, CTDecimal, int(bool b, char c, short d, int e, long f, float g, double h, unsigned i,
                                        char* j, const string& k));
        ...
        public:
            ...
            STDMETHOD_(void, Push)(const T& value);
            STDMETHOD_(void, Pop)();
            STDMETHOD_(int, GetSize)() const;
            STDMETHOD_(const T&, GetTop)() const;
        };
        template <typename T> class MockStackWithCallType : public StackInterfaceWithCallType<T> {
        public:
