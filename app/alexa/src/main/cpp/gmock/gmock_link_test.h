...
public:
    virtual ~Interface() {}
    virtual void VoidFromString(char* str);
    virtual char* StringFromString(char* str);
    virtual int IntFromString(char* str);
    virtual int& IntRefFromString(char* str);
    virtual void VoidFromFunc(void(*func)(char* str));
    virtual void VoidFromIntRef(int& n);
    virtual void VoidFromFloat(float n);
    virtual void VoidFromDouble(double n);
    virtual void VoidFromVector(const std::vector<int>& v);
};
...
TEST(LinkTest, TestInvoke) {
    ...
    EXPECT_CALL(mock, VoidFromString(_)).WillOnce(Invoke(&InvokeHelper::StaticVoidFromString))
...
TEST(LinkTest, TestInvokeWithoutArgs) {
    Mock mock;
    InvokeHelper test_invoke_helper;
    EXPECT_CALL(mock, VoidFromString(_)).WillOnce(InvokeWithoutArgs(&InvokeHelper::StaticVoidFromVoid))
...
TEST(LinkTest, TestInvokeArgument) {
    Mock mock;
    char ch = 'x';
    EXPECT_CALL(mock, VoidFromFunc(_)).WillOnce(testing::InvokeArgument<0>(&ch));
