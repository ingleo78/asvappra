...
namespace {
    ...
    TEST(MatcherTupleTest, ForSize5) {
        CompileAssertTypesEqual<tuple<Matcher<int>, Matcher<char>, Matcher<bool>, Matcher<double>, Matcher<char*>>,
    ...
    TEST(FunctionTest, Unary) {
        ...
        CompileAssertTypesEqual<IgnoredValue(bool), F::MakeResultIgnoredValue>();
    }
    TEST(FunctionTest, Binary) {
        ...
        CompileAssertTypesEqual<tuple<Matcher<bool>, Matcher<const long&> >, F::ArgumentMatcherTuple>();
        CompileAssertTypesEqual<void(bool, const long&), F::MakeResultVoid>();
        CompileAssertTypesEqual<IgnoredValue(bool, const long&), F::MakeResultIgnoredValue>();
    }
    TEST(FunctionTest, LongArgumentList) {
        ...
        CompileAssertTypesEqual<tuple<bool, int, char*, int&, const long&>, F::ArgumentTuple>();
        CompileAssertTypesEqual<tuple<Matcher<bool>, Matcher<int>, Matcher<char*>, Matcher<int&>, Matcher<const long&> >, F::ArgumentMatcherTuple>();
        CompileAssertTypesEqual<void(bool, int, char*, int&, const long&), F::MakeResultVoid>();
        CompileAssertTypesEqual<IgnoredValue(bool, int, char*, int&, const long&), F::MakeResultIgnoredValue>();
    }
}