...
namespace testing {
    namespace internal {
        ...
        template <typename R, typename A1, typename A2, typename A3, typename A4,
            typename A5> class FunctionMocker<R(A1, A2, A3, A4, A5)> : public internal::FunctionMockerBase<R(A1, A2, A3, A4, A5)> {
        public:
        ...
        template <typename R, typename A1, typename A2, typename A3, typename A4,
            typename A5, typename A6> class FunctionMocker<R(A1, A2, A3, A4, A5, A6)> : public internal::FunctionMockerBase<R(A1, A2, A3, A4, A5, A6)> {
        public:
        ...
        template <typename R, typename A1, typename A2, typename A3, typename A4,
            typename A5, typename A6, typename A7> class FunctionMocker<R(A1, A2, A3, A4, A5, A6, A7)> : public internal::FunctionMockerBase<R(A1, A2, A3, A4, A5, A6, A7)> {
        public:
        ...
        template <typename R, typename A1, typename A2, typename A3, typename A4,
            typename A5, typename A6, typename A7, typename A8> class FunctionMocker<R(A1, A2, A3, A4, A5, A6, A7, A8)> : public internal::FunctionMockerBase<R(A1, A2, A3, A4, A5, A6, A7, A8)> {
        public:
        ...
        template <typename R, typename A1, typename A2, typename A3, typename A4,
            typename A5, typename A6, typename A7, typename A8, typename A9> class FunctionMocker<R(A1, A2, A3, A4, A5, A6, A7, A8, A9)> :
        public internal::FunctionMockerBase<R(A1, A2, A3, A4, A5, A6, A7, A8, A9)> {
        public:
            typedef R F(A1, A2, A3, A4, A5, A6, A7, A8, A9);
            typedef typename internal::Function<F>::ArgumentTuple ArgumentTuple;
            MockSpec<F>& With(const Matcher<A1>& m1, const Matcher<A2>& m2, const Matcher<A3>& m3, const Matcher<A4>& m4, const Matcher<A5>& m5,
                              const Matcher<A6>& m6, const Matcher<A7>& m7, const Matcher<A8>& m8, const Matcher<A9>& m9) {
        ...
        template <typename R, typename A1, typename A2, typename A3, typename A4,
            ...
            typename A10> class FunctionMocker<R(A1, A2, A3, A4, A5, A6, A7, A8, A9, A10)> :
        public internal::FunctionMockerBase<R(A1, A2, A3, A4, A5, A6, A7, A8, A9, A10)> {
        public:
            typedef R F(A1, A2, A3, A4, A5, A6, A7, A8, A9, A10);
            typedef typename internal::Function<F>::ArgumentTuple ArgumentTuple;
            MockSpec<F>& With(const Matcher<A1>& m1, const Matcher<A2>& m2, const Matcher<A3>& m3, const Matcher<A4>& m4, const Matcher<A5>& m5,
                              const Matcher<A6>& m6, const Matcher<A7>& m7, const Matcher<A8>& m8, const Matcher<A9>& m9, const Matcher<A10>& m10) {
    ...
    #define GMOCK_METHOD0_(tn, constness, ct, Method, ...) \
      GMOCK_RESULT_(tn, __VA_ARGS__) ct Method() constness { \
          GTEST_COMPILE_ASSERT_((::testing::tuple_size<tn ::testing::internal::Function<__VA_ARGS__>::ArgumentTuple>::value == 0), \
    ...
    #define GMOCK_METHOD1_(tn, constness, ct, Method, ...) \
      GMOCK_RESULT_(tn, __VA_ARGS__) ct Method(GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1) constness { \
          GTEST_COMPILE_ASSERT_((::testing::tuple_size<tn ::testing::internal::Function<__VA_ARGS__>::ArgumentTuple>::value == 1), \
    ...
    #define GMOCK_METHOD2_(tn, constness, ct, Method, ...) \
      GMOCK_RESULT_(tn, __VA_ARGS__) ct Method(GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2) constness { \
          GTEST_COMPILE_ASSERT_((::testing::tuple_size<tn ::testing::internal::Function<__VA_ARGS__>::ArgumentTuple>::value == 2), \
                                this_method_does_not_take_2_arguments); \
          GMOCK_MOCKER_(2, constness, Method).SetOwnerAndName(this, #Method); \
          return GMOCK_MOCKER_(2, constness, Method).Invoke(gmock_a1, gmock_a2); \
      } \
      ::testing::MockSpec<__VA_ARGS__>& gmock_##Method(GMOCK_MATCHER_(tn, 1, __VA_ARGS__) gmock_a1, GMOCK_MATCHER_(tn, 2, __VA_ARGS__) \
          gmock_a2) constness { \
    ...
    #define GMOCK_METHOD3_(tn, constness, ct, Method, ...) \
      GMOCK_RESULT_(tn, __VA_ARGS__) ct Method(GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
          GMOCK_ARG_(tn, 3, __VA_ARGS__) gmock_a3) constness { \
          GTEST_COMPILE_ASSERT_((::testing::tuple_size<tn ::testing::internal::Function<__VA_ARGS__>::ArgumentTuple>::value == 3), \
                                this_method_does_not_take_3_arguments); \
          GMOCK_MOCKER_(3, constness, Method).SetOwnerAndName(this, #Method); \
          return GMOCK_MOCKER_(3, constness, Method).Invoke(gmock_a1, gmock_a2, gmock_a3); \
      } \
      ::testing::MockSpec<__VA_ARGS__>& gmock_##Method(GMOCK_MATCHER_(tn, 1, __VA_ARGS__) gmock_a1, GMOCK_MATCHER_(tn, 2, __VA_ARGS__) gmock_a2, \
    ...
    #define GMOCK_METHOD4_(tn, constness, ct, Method, ...) \
      GMOCK_RESULT_(tn, __VA_ARGS__) ct Method(GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
          ...
          GTEST_COMPILE_ASSERT_((::testing::tuple_size<tn ::testing::internal::Function<__VA_ARGS__>::ArgumentTuple>::value == 4), \
    ...
    #define GMOCK_METHOD5_(tn, constness, ct, Method, ...) \
      GMOCK_RESULT_(tn, __VA_ARGS__) ct Method(GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
          ...
          GTEST_COMPILE_ASSERT_((::testing::tuple_size<tn ::testing::internal::Function<__VA_ARGS__>::ArgumentTuple>::value == 5), \
    ...
    #define GMOCK_METHOD6_(tn, constness, ct, Method, ...) \
      GMOCK_RESULT_(tn, __VA_ARGS__) ct Method(GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
          ...
          GTEST_COMPILE_ASSERT_((::testing::tuple_size<tn ::testing::internal::Function<__VA_ARGS__>::ArgumentTuple>::value == 6), \
    ...
    #define GMOCK_METHOD7_(tn, constness, ct, Method, ...) \
      GMOCK_RESULT_(tn, __VA_ARGS__) ct Method(GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
          ...
          GTEST_COMPILE_ASSERT_((::testing::tuple_size<tn ::testing::internal::Function<__VA_ARGS__>::ArgumentTuple>::value == 7), \
    ...
    #define GMOCK_METHOD8_(tn, constness, ct, Method, ...) \
      GMOCK_RESULT_(tn, __VA_ARGS__) ct Method(GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
          ...
          GTEST_COMPILE_ASSERT_((::testing::tuple_size<tn ::testing::internal::Function<__VA_ARGS__>::ArgumentTuple>::value == 8), \
    ...
    #define GMOCK_METHOD9_(tn, constness, ct, Method, ...) \
      GMOCK_RESULT_(tn, __VA_ARGS__) ct Method(GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
          ...
          GTEST_COMPILE_ASSERT_((::testing::tuple_size<tn ::testing::internal::Function<__VA_ARGS__>::ArgumentTuple>::value == 9), \
                                this_method_does_not_take_9_arguments); \
          GMOCK_MOCKER_(9, constness, Method).SetOwnerAndName(this, #Method); \
          return GMOCK_MOCKER_(9, constness, Method).Invoke(gmock_a1, gmock_a2, gmock_a3, gmock_a4, gmock_a5, gmock_a6, gmock_a7, gmock_a8, \
                               gmock_a9); \
      } \
      ::testing::MockSpec<__VA_ARGS__>& gmock_##Method(GMOCK_MATCHER_(tn, 1, __VA_ARGS__) gmock_a1, GMOCK_MATCHER_(tn, 2, __VA_ARGS__) gmock_a2,\
                                                       GMOCK_MATCHER_(tn, 3, __VA_ARGS__) gmock_a3, GMOCK_MATCHER_(tn, 4, __VA_ARGS__) gmock_a4,\
          ...
          return GMOCK_MOCKER_(9, constness, Method).With(gmock_a1, gmock_a2, gmock_a3, gmock_a4, gmock_a5, gmock_a6, gmock_a7, gmock_a8, \
                               gmock_a9); \
      } \
    ...
    #define GMOCK_METHOD10_(tn, constness, ct, Method, ...) \
      GMOCK_RESULT_(tn, __VA_ARGS__) ct Method(GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
        ...
        GTEST_COMPILE_ASSERT_((::testing::tuple_size<tn ::testing::internal::Function<__VA_ARGS__>::ArgumentTuple>::value == 10), \
                              this_method_does_not_take_10_arguments); \
        GMOCK_MOCKER_(10, constness, Method).SetOwnerAndName(this, #Method); \
        return GMOCK_MOCKER_(10, constness, Method).Invoke(gmock_a1, gmock_a2, gmock_a3, gmock_a4, gmock_a5, gmock_a6, gmock_a7, gmock_a8, \
                                                           gmock_a9, gmock_a10); \
      } \
      ::testing::MockSpec<__VA_ARGS__>& gmock_##Method(GMOCK_MATCHER_(tn, 1, __VA_ARGS__) gmock_a1, GMOCK_MATCHER_(tn, 2, __VA_ARGS__) gmock_a2,\
                                                       GMOCK_MATCHER_(tn, 3, __VA_ARGS__) gmock_a3, GMOCK_MATCHER_(tn, 4, __VA_ARGS__) gmock_a4,\
          ...
          return GMOCK_MOCKER_(10, constness, Method).With(gmock_a1, gmock_a2, gmock_a3, gmock_a4, gmock_a5, gmock_a6, gmock_a7, gmock_a8, \
                               gmock_a9, gmock_a10); \
      } \
    ...
    template <typename R, typename A0, typename A1, typename A2, typename A3,
        typename A4> class MockFunction<R(A0, A1, A2, A3, A4)> {
    public:
        MockFunction() {}
    ...
    template <typename R, typename A0, typename A1, typename A2, typename A3,
        typename A4, typename A5> class MockFunction<R(A0, A1, A2, A3, A4, A5)> {
    public:
        MockFunction() {}
    ...
    template <typename R, typename A0, typename A1, typename A2, typename A3,
        typename A4, typename A5, typename A6> class MockFunction<R(A0, A1, A2, A3, A4, A5, A6)> {
    public:
        MockFunction() {}
    ...
    template <typename R, typename A0, typename A1, typename A2, typename A3,
        typename A4, typename A5, typename A6, typename A7> class MockFunction<R(A0, A1, A2, A3, A4, A5, A6, A7)> {
    public:
        MockFunction() {}
    ...
    template <typename R, typename A0, typename A1, typename A2, typename A3,
        typename A4, typename A5, typename A6, typename A7, typename A8> class MockFunction<R(A0, A1, A2, A3, A4, A5, A6, A7, A8)> {
    public:
        MockFunction() {}
    ...
    template <typename R, typename A0, typename A1, typename A2, typename A3,
        ...
        typename A9> class MockFunction<R(A0, A1, A2, A3, A4, A5, A6, A7, A8, A9)> {
    public:
        MockFunction() {}
