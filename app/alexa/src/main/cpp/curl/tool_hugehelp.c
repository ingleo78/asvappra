...
void hugehelp(void) {
   fputs("                                  _   _ ____  _\n"
         ...
         , stdout);
   fputs("       IMAPS,  LDAP,  LDAPS,  MQTT, POP3, POP3S, RTMP, RTMPS, RTSP, SCP, SFTP,\n"
         ...
         "\n"
         , stdout);
   fputs("       curl is powered by  libcurl  for  all  transfer-related  features.  See\n"
         ...
         "\n"
         , stdout);
   fputs("         \"ftp://ftp.example.com/file[1-100].txt\"\n"
         "\n"
         ...
         , stdout);
   fputs("       fetched  in a sequential manner in the specified order. You can specify\n"
         ...
         , stdout);
   fputs("       you probably have to put the full URL within double quotes to avoid the\n"
         ...
         , stdout);
   fputs("       guess  what  protocol  you might want. It will then default to HTTP but\n"
         ...
         "\n"
         , stdout);
   fputs("       curl will attempt to re-use connections for multiple file transfers, so\n"
         ...
         , stdout);
   fputs("       the  amount  of  transferred  data,  transfer speeds and estimated time\n"
         ...
         , stdout);
   fputs("       it disables the progress meter as otherwise it would mess up the output\n"
         ...
         "\n"
         , stdout);
   fputs("       If you prefer a progress  \"bar\"  instead  of  the  regular  meter,  -#,\n"
         ...
         , stdout);
   fputs("       is a recommended separator. The long \"double-dash\" form, -d, --data for\n"
         ...
         , stdout);
   fputs("       disabled  with --no-option. That is, you use the exact same option name\n"
         ...
         , stdout);
   fputs("              of using the network.  Note: netstat shows the path  of  an  ab-\n"
         ...
         , stdout);
   fputs("              points to an existing alt-svc cache file, that will be used. Af-\n"
   ...
   fputs("\nAdded in 7.64.1.\n\n--anyauth\n"
         ...
         , stdout);
   fputs("              method,  which  you  can  do with --basic, --digest, --ntlm, and\n"
         "              --negotiate.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("              See also --proxy-anyauth and --basic and --digest.\n"
         "\n"
         "       -a, --append\n"
         ...
         , stdout);
   fputs("              mote host. This is the default and this option is usually point-\n"
         ...
         , stdout);
   fputs("              the  peer.  The  file  may contain multiple CA certificates. The\n"
         ...
         "\n"
         , stdout);
   fputs("              The windows version of curl will automatically  look  for  a  CA\n"
         ...
         "\n"
         , stdout);
   fputs("              (iOS  and macOS only) If curl is built against Secure Transport,\n"
         ...
         "\n"
         , stdout);
   fputs("              (Schannel only) This option is supported for Schannel in Windows\n"
         ...
         "       --capath <dir>\n"
         , stdout);
   fputs("              (TLS) Tells curl to use the specified certificate  directory  to\n"
         ...
         , stdout);
   fputs("              curl to make SSL-connections much more  efficiently  than  using\n"
   ...
   fputs("              extension.\n"
         ...
         "       --cert-type <type>\n"
         , stdout);
   fputs("              (TLS) Tells curl what type the provided  client  certificate  is\n"
         ...
         , stdout);
   fputs("              when getting a file with HTTPS, FTPS or another SSL-based proto-\n"
         ...
         , stdout);
   fputs("              See -E, --cert and --key to specify them independently.\n"
         "\n"
         ...
         , stdout);
   fputs("              want to use a file from the current directory, please precede it\n"
         ...
         "\n"
         , stdout);
   fputs("              If  curl is built against OpenSSL library, and the engine pkcs11\n"
         ...
         , stdout);
   fputs("              set as \"ENG\" if none was provided.\n"
         "\n"
         ...
         , stdout);
   fputs("              \"./\" prefix, in order to avoid confusion with a nickname.\n"
         "\n"
         ...
         , stdout);
   fputs("              tUser\\MY\\934a7ac6f8a5d579285a74fa61e19f23ddfe8d7a\".   Thumbprint\n"
         ...
         "\n"
         , stdout);
   fputs("              See also --cert-type and --key and --key-type.\n"
         "\n"
         ...
         "       --compressed-ssh\n"
         , stdout);
   fputs("              (SCP SFTP) Enables built-in SSH compression.  This is a request,\n"
         ...
         , stdout);
   fputs("              coding, curl will report an error.\n"
         "\n"
         "       -K, --config <file>\n"
         "\n"
   ...
   fputs(
         ...
         , stdout);
   fputs("              the parameter must be  enclosed  within  quotes.  Within  double\n"
         ...
         "\n"
         , stdout);
   fputs("              Specify  the  filename  to -K, --config as '-' to make curl read\n"
         "              the file from stdin.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("              When  curl  is invoked, it (unless -q, --disable is used) checks\n"
         ...
         , stdout);
   fputs("              dir given the current user in your system). On Windows, it  then\n"
   ...
   fputs("              files.\n"
         ...
         "\n"
         , stdout);
   fputs("       --connect-to <HOST1:PORT1:HOST2:PORT2>\n"
         "\n"
         ...
         , stdout);
   fputs("              used for TLS/SSL (e.g. SNI, certificate verification) or for the\n"
         ...
         , stdout);
   fputs("              needs  to  match  the name used in request URL. It can be either\n"
         ...
         , stdout);
   fputs("              The given offset is the exact  number  of  bytes  that  will  be\n"
   ...
   fputs("              If this option is used several times, the last one will be used.\n"
         ...
         , stdout);
   fputs("              file  will  be written using the Netscape cookie file format. If\n"
         ...
         , stdout);
   fputs("              operation won't fail or even report an error clearly. Using  -v,\n"
         ...
         , stdout);
   fputs("              is supposedly the data previously received from the server in  a\n"
         ...
         , stdout);
   fputs("              coming  cookies, which may be handy if you're using this in com-\n"
         ...
         "\n"
         , stdout);
   fputs("              The file specified with -b, --cookie is only used as  input.  No\n"
         ...
         , stdout);
   fputs("              then the cookie is sent for any domain (even after redirects are\n"
   ...
   fputs("              the Netscape format.\n"
         ...
         , stdout);
   fputs("              create the necessary local directory hierarchy as  needed.  This\n"
         ...
         "\n"
         , stdout);
   fputs("       --crlf (FTP SMTP)  Convert  LF  to  CRLF  in  upload.  Useful  for  MVS\n"
         "              (OS/390).\n"
         "\n"
         ...
         "       --data-ascii <data>\n"
         , stdout);
   fputs("              (HTTP) This is just an alias for -d, --data.\n"
         "\n"
         "       --data-binary <data>\n"
         ...
         "\n"
         , stdout);
   fputs("              Like  -d,  --data the default content-type sent to the server is\n"
   ...
   fputs("       --data-raw <data>\n"
         ...
         , stdout);
   fputs("              followed  by a separator and a content specification. The <data>\n"
         ...
         "              =content\n"
         , stdout);
   fputs("                     This  will make curl URL-encode the content and pass that\n"
         ...
         , stdout);
   fputs("                     cluding  any  newlines), URL-encode that data and pass it\n"
         "                     on in the POST.\n"
         "\n"
         "              name@filename\n"
         "                     This will make curl load data from the  given  file  (in-\n"
         ...
         , stdout);
   fputs("                     that the name is expected to be URL-encoded already.\n"
         ...
         , stdout);
   fputs("              application/x-www-form-urlencoded.  Compare to -F, --form.\n"
         "\n"
         ...
         , stdout);
   fputs("              mand line, the data pieces specified  will  be  merged  together\n"
         ...
         , stdout);
   fputs("              the  data  from  stdin.  Posting data from a file named 'foobar'\n"
         ...
         , stdout);
   fputs("              option overrides -F, --form and -I,  --head  and  -T,  --upload-\n"
         "              file.\n"
         "\n"
         "       --delegation <LEVEL>\n"
   ...
   fputs("              used.\n"
         ...
         , stdout);
   fputs("              option, it will use PORT right away. EPRT and  LPRT  are  exten-\n"
         ...
         , stdout);
   fputs("              effect as EPRT is necessary then.\n"
         "\n"
         ...
         , stdout);
   fputs("              first  attempt to use EPSV before PASV, but with this option, it\n"
         ...
         , stdout);
   fputs("              switch to active mode you need to use -P, --ftp-port.\n"
         "\n"
         "       -q, --disable\n"
   ...
   fputs("\n       --dns-ipv4-addr <address>\n"
         ...
         , stdout);
   fputs("              (DNS) Tell curl to bind to <ip-address> when making IPv6 DNS re-\n"
         "              quests, so that the DNS requests originate  from  this  address.\n"
         ...
         , stdout);
   fputs("              Set the list of DNS servers to be used instead of the system de-\n"
         ...
         "       --doh-url <URL>\n"
         , stdout);
   fputs("              (all)  Specifies which DNS-over-HTTPS (DOH) server to use to re-\n"
         ...
         "\n"
         , stdout);
   fputs("              This option is handy to use when you want to store  the  headers\n"
         ...
         "\n"
         , stdout);
   fputs("              When  used  in FTP, the FTP server response lines are considered\n"
   ...
   fputs("              See also --random-file.\n"
         ...
         , stdout);
   fputs("              cific ETag read from the given file by sending a custom If-None-\n"
   ...
   fputs("              in a subsequent request.\n"
         ...
         , stdout);
   fputs("              This  option  extracts  the  ETag  without the double quotes and\n"
         ...
         "\n"
         , stdout);
   fputs("       --expect100-timeout <seconds>\n"
         ...
         "       --fail-early\n"
         , stdout);
   fputs("              Fail and exit on the first detected transfer error.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("              Using this option, curl will instead  return  an  error  on  the\n"
         ...
         , stdout);
   fputs("              fail  due  to the server's HTTP status code. You can combine the\n"
         ...
         , stdout);
   fputs("              deliver a document, it  returns  an  HTML  document  stating  so\n"
         ...
         "       --false-start\n"
         , stdout);
   fputs("              (TLS) Tells curl to use false start during  the  TLS  handshake.\n"
   ...
   fputs("              See also -F, --form.\n"
         ...
         "\n"
         , stdout);
   fputs("              This  enables  uploading of binary files etc. To force the 'con-\n"
   ...
   fputs("              field from a file.\n"
         ...
         , stdout);
   fputs("              ilar) is unfortunately not subject to buffering and will be  ef-\n"
         ...
         "\n"
         , stdout);
   fputs("               curl -F profile=@portrait.jpg https://example.com/upload.cgi\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("              You can also  tell  curl  what  Content-Type  to  use  by  using\n"
         ...
         "\n"
         , stdout);
   fputs("              If filename/path contains ',' or ';', it must be quoted by  dou-\n"
         "              ble-quotes like:\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("              Quoting must also be applied to non-file  data  if  it  contains\n"
         ...
         "\n"
         , stdout);
   fputs("                curl -F \"submit=OK;headers=@headerfile\" example.com\n"
         "\n"
         ...
         , stdout);
   fputs("              and trailing spaces are stripped.   Here  is  an  example  of  a\n"
         ...
         "              tended as follows:\n"
         , stdout);
   fputs("              - name can be omitted: the equal sign is the first character  of\n"
         "              the argument,\n"
         ...
         , stdout);
   fputs("              and HTML. It attaches a text file:\n"
         "\n"
         ...
         , stdout);
   fputs("              corresponding Content-Transfer-Encoding header, 7bit  that  only\n"
         ...
         , stdout);
   fputs("                    -F '=@localfile;encoder=base64' ... smtp://example.com\n"
         "\n"
   ...
   fputs("              the certificate.\n"
         ...
         "       --ftp-method <method>\n"
         , stdout);
   fputs("              (FTP) Control what method curl should use to reach a file on  an\n"
         ...
         , stdout);
   fputs("                     This is the default but the slowest behavior.\n"
         "\n"
         ...
         , stdout);
   fputs("                     case).  This  is  somewhat  more standards compliant than\n"
         ...
         "              If this option is used several times,  only  the  first  one  is\n"
         , stdout);
   fputs("              used.  Undoing  an  enforced passive really isn't doable but you\n"
         ...
         , stdout);
   fputs("              necting with FTP. This option makes curl use active  mode.  curl\n"
   ...
   fputs("              IP address\n"
         ...
         , stdout);
   fputs("       EPRT command instead of PORT by using --disable-eprt.  EPRT  is  really\n"
         "       PORT++.\n"
         "\n"
   ...
   fputs("       --ftp-pret\n"
         ...
         , stdout);
   fputs("              connection. Instead curl will re-use the same IP address it  al-\n"
         ...
         , stdout);
   fputs("              reply to the shutdown from the server. The active mode initiates\n"
         ...
         , stdout);
   fputs("              low the FTP transaction. The default mode is passive.\n"
         "\n"
         ...
         "       -G, --get\n"
         , stdout);
   fputs("              When  used,  this  option  will make all data specified with -d,\n"
         ...
         "\n"
         , stdout);
   fputs("              If  this  option  is  used  several times, only the first one is\n"
         ...
         , stdout);
   fputs("              these letters are not normal legal URL contents but they  should\n"
         ...
         , stdout);
   fputs("              be connected to within that time then a  connection  attempt  is\n"
         ...
         , stdout);
   fputs("              load.\"  libcurl currently defaults to 200 ms. Firefox and Chrome\n"
         ...
         , stdout);
   fputs("              This option is primarily useful when sending test requests to  a\n"
   ...
   fputs(
         ...
         , stdout);
   fputs("              to  make  even  trickier  stuff than curl would normally do. You\n"
         ...
         , stdout);
   fputs("              as -H \"X-Custom-Header;\" to send \"X-Custom-Header:\".\n"
         "\n"
         ...
         , stdout);
   fputs("              name  style, which then adds a header for each line in the input\n"
         ...
         "\n"
         , stdout);
   fputs("              WARNING:  headers  set  with  this option will be set in all re-\n"
   ...
   fputs("       -h, --help\n"
         ...
         "       --http0.9\n"
         , stdout);
   fputs("              (HTTP) Tells curl to be fine with HTTP version 0.9 response.\n"
         "\n"
         ...
         "       -0, --http1.0\n"
         , stdout);
   fputs("              (HTTP)  Tells  curl to use HTTP version 1.0 instead of using its\n"
         ...
         , stdout);
   fputs("              HTTP/2 without HTTP/1.1 Upgrade.  It  requires  prior  knowledge\n"
   ...
   fputs("       --http2\n"
         ...
         "\n"
         , stdout);
   fputs("              Tells  curl  to use HTTP version 3 directly to the host and port\n"
         ...
         , stdout);
   fputs("              established, it cannot fall back to a lower HTTP version on  its\n"
         "              own.\n"
         "\n"
         ...
         , stdout);
   fputs("              particularly  useful  for servers running Apache 1.x, which will\n"
   ...
   fputs("              date of the document, HTTP version and more...\n"
         ...
         "\n"
         , stdout);
   fputs("              The server connection is verified by making  sure  the  server's\n"
         ...
         , stdout);
   fputs("              interface  name,  IP address or host name. An example could look\n"
         "              like:\n"
         "\n"
   ...
   fputs("              tion/networking/vrf.txt\n"
         ...
         "\n"
         , stdout);
   fputs("              See also  --http1.1  and  --http2.  This  option  overrides  -4,\n"
         "              --ipv4.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("              See also -b, --cookie and -c, --cookie-jar.\n"
         "\n"
         ...
         , stdout);
   fputs("              effect if --no-keepalive is used.\n"
         "\n"
         "              If this option is used several times, the last one will be used.\n"
   ...
   fputs("              If this option is used several times, the last one will be used.\n"
         ...
         , stdout);
   fputs("              is available, then a PKCS#11 URI (RFC 7512) can be used to spec-\n"
   ...
   fputs("              If this option is used several times, the last one will be used.\n"
         ...
         "              If this option is used several times, the last one will be used.\n"
         , stdout);
   fputs("              --krb  requires that the underlying libcurl was built to support\n"
         "              Kerberos.\n"
         "\n"
         "       --libcurl <file>\n"
   ...
   fputs("              Added in 7.16.1.\n"
         ...
         , stdout);
   fputs("              appended.   Appending  'k' or 'K' will count the number as kilo-\n"
   ...
   fputs("              If this option is used several times, the last one will be used.\n"
         ...
         , stdout);
   fputs("              to the server instead of LIST.\n"
         "\n"
         ...
         , stdout);
   fputs("              sage id exists on the server and what size it is.\n"
         "\n"
         ...
         , stdout);
   fputs("              numbers to use for the connection(s).  Note that port numbers by\n"
         ...
         , stdout);
   fputs("              may not introduce a security breach if the site redirects you to\n"
         ...
         , stdout);
   fputs("              3XX  response code), this option will make curl redo the request\n"
         ...
         , stdout);
   fputs("              tion-trusted  on how to change this. You can limit the amount of\n"
         ...
         "\n"
         , stdout);
   fputs("              You can tell curl to not change POST requests to GET after a 30x\n"
         ...
         "\n"
         , stdout);
   fputs("              You can use the login options to specify protocol  specific  op-\n"
   ...
   fputs("       --mail-auth <address>\n"
         ...
         "\n"
         , stdout);
   fputs("              See also --mail-rcpt and --mail-auth. Added in 7.20.0.\n"
         "\n"
         ...
         , stdout);
   fputs("              and proceed with the remaining valid recipients.\n"
         "\n"
         ...
         , stdout);
   fputs("              When performing a mail transfer, the recipient should specify  a\n"
        ...
        , stdout);
   fputs("              ient should be specified using the mailing list  name,  such  as\n"
         ...
         "\n"
         , stdout);
   fputs("              A  size  modifier may be used. For example, Appending 'k' or 'K'\n"
         ...
         , stdout);
   fputs("              fer ends up being larger than this given  limit.  This  concerns\n"
   ...
   fputs("              If this option is used several times, the last one will be used.\n"
         ...
         , stdout);
   fputs("              out will decrease in accuracy as the specified timeout increases\n"
         ...
         , stdout);
   fputs("              are errors (such as the file or server not being available).  It\n"
         ...
         "\n"
         , stdout);
   fputs("              To use a Metalink file in the local file system, use FILE proto-\n"
         "              col (file://):\n"
         "\n"
         ...
         , stdout);
   fputs("              the response will break Metalink parser and if the  headers  are\n"
         ...
         , stdout);
   fputs("              port. Use -V, --version  to  see  if  your  curl  supports  GSS-\n"
         "              API/SSPI or SPNEGO.\n"
         "\n"
   ...
   fputs("              used.\n"
         ...
         "\n"
         , stdout);
   fputs("              It will abide by --netrc-optional if specified.\n"
        "\n"
        ...
        , stdout);
   fputs("              user's home directory for login name and password. This is typi-\n"
         ...
         "\n"
         , stdout);
   fputs("              A  quick and very simple example of how to setup a .netrc to al-\n"
         ...
         , stdout);
   fputs("              quests,  each with their own specific options, for example, such\n"
         ...
         "\n"
         , stdout);
   fputs("              For  example,  you can do both a GET and a POST in a single com-\n"
         "              mand line:\n"
         "\n"
         ...
         , stdout);
   fputs("              ate HTTP/2 support with the server during https sessions.\n"
         "\n"
         ...
         , stdout);
   fputs("              necessarily  exactly  when  the data arrives.  Using this option\n"
   ...
   fputs("              thus use --keepalive to enforce keepalive.\n"
         ...
         , stdout);
   fputs("              derlying libcurl was built to support TLS. Added in 7.36.0.\n"
         "\n"
         "       --no-progress-meter\n"
         ...
         "\n"
         , stdout);
   fputs("              See also -v, --verbose and -s, --silent. Added in 7.67.0.\n"
         "\n"
         "       --no-sessionid\n"
         ...
         "\n"
         , stdout);
   fputs("              Note that this is the negated option name  documented.  You  can\n"
         ...
         , stdout);
   fputs("              in this list is matched as either a domain  which  contains  the\n"
         ...
         , stdout);
   fputs("              abling a proxy, you can set noproxy list to \"\" to override it.\n"
         "\n"
         "              Added in 7.19.4.\n"
         "\n"
         "       --ntlm-wb\n"
         ...
         , stdout);
   fputs("              method was designed by Microsoft and is used by IIS web servers.\n"
         ...
         "\n"
         , stdout);
   fputs("              If  you  want to enable NTLM for your proxy authentication, then\n"
         "              use --proxy-ntlm.\n"
         "\n"
         "              If this option is used several times,  only  the  first  one  is\n"
         "              used.\n"
         ...
         "       --oauth2-bearer <token>\n"
         , stdout);
   fputs("              (IMAP  POP3  SMTP  HTTP)  Specify the Bearer Token for OAUTH 2.0\n"
         ...
         "       -o, --output <file>\n"
         , stdout);
   fputs("              Write output to <file> instead of stdout. If you are using {} or\n"
         ...
         "\n"
         , stdout);
   fputs("               curl \"http://{site,host}.host[1-5].com\" -o \"#1_#2\"\n"
         "\n"
   ...
   fputs("              above command line can also be written as\n"
         ...
         "       --parallel-immediate\n"
         , stdout);
   fputs("              When doing parallel transfers, this option  will  instruct  curl\n"
         ...
         , stdout);
   fputs("              option controls the maximum amount of transfers to do simultane-\n"
         "              ously.\n"
         "\n"
         "              The default is 50.\n"
         "\n"
   ...
   fputs("              If this option is used several times, the last one will be used.\n"
         ...
         , stdout);
   fputs("              hashes)  to  verify the peer. This can be a path to a file which\n"
         ...
         , stdout);
   fputs("              from this certificate and if it does not exactly match the  pub-\n"
         ...
         , stdout);
   fputs("                7.47.0: mbedtls Other SSL backends not supported.\n"
         "\n"
         "              If this option is used several times, the last one will be used.\n"
         "\n"
         "       --post301\n"
         ...
         , stdout);
   fputs("              server may require a POST to remain a POST after  such  a  redi-\n"
         ...
         , stdout);
   fputs("              non-RFC  behaviour  is  ubiquitous in web browsers, so curl does\n"
         "              the conversion by default to maintain  consistency.  However,  a\n"
         ...
         "       --post303\n"
         , stdout);
   fputs("              (HTTP) Tells curl to violate RFC 7231/6.4.4 and not convert POST\n"
         ...
         , stdout);
   fputs("              Use the specified SOCKS proxy before connecting to  an  HTTP  or\n"
         ...
         , stdout);
   fputs("              socks4a://,  socks5://  or  socks5h://  to  request the specific\n"
         ...
         , stdout);
   fputs("              ters such as @ by using %40 or pass in a colon with %3a.\n"
         "\n"
         "              If this option is used several times, the last one will be used.\n"
         "\n"
         "              Added in 7.52.0.\n"
         ...
         , stdout);
   fputs("              the screen and shows a percentage if the transfer size is known.\n"
         ...
         "\n"
         , stdout);
   fputs("               curl --proto-default https ftp.mozilla.org\n"
         "\n"
         ...
         , stdout);
   fputs("              Tells  curl to limit what protocols it may use on redirect. Pro-\n"
         ...
         , stdout);
   fputs("              (7.65.2).  Older versions of curl allowed all protocols on redi-\n"
         ...
         "       --proto <protocols>\n"
         , stdout);
   fputs("              Tells curl to limit what protocols it may use in  the  transfer.\n"
         ...
         "\n"
         , stdout);
   fputs("              -  Deny this protocol, removing it from the  list  of  protocols\n"
         "                 already permitted.\n"
         "\n"
         ...
         , stdout);
   fputs("                             only enables http and https\n"
         "\n"
         "              --proto =http,https\n"
         ...
         , stdout);
   fputs("       same as concatenating the protocols into one instance of the option.\n"
         "\n"
         ...
         "       --proxy-basic\n"
         , stdout);
   fputs("              Tells curl to use HTTP Basic authentication  when  communicating\n"
         ...
         "\n"
         , stdout);
   fputs("              See  also  --proxy-capath  and  --cacert  and  --capath  and -x,\n"
         ...
         , stdout);
   fputs("              Same as -E, --cert but used in HTTPS proxy context.\n"
         "\n"
         "              Added in 7.52.0.\n"
         "\n"
         "       --proxy-ciphers <list>\n"
         ...
         , stdout);
   fputs("              with the given proxy. Use --digest for enabling HTTP Digest with\n"
         "              a remote host.\n"
         "\n"
         ...
         , stdout);
   fputs("              cation only like in CONNECT requests when you  want  a  separate\n"
         ...
         "\n"
         , stdout);
   fputs("              Headers  specified  with this option will not be included in re-\n"
   ...
   fputs("       --proxy-service-name <name>\n"
         ...
         , stdout);
   fputs("              your HTTPS proxy when it negotiates TLS 1.3. The list of ciphers\n"
   ...
   fputs("              Added in 7.52.0.\n"
         ...
         , stdout);
   fputs("              the user name and password from your environment by specifying a\n"
         ...
         , stdout);
   fputs("              cleared. Such sensitive data should be retrieved from a file in-\n"
         ...
         , stdout);
   fputs("              socks4://, socks4a://, socks5:// or socks5h:// to request a spe-\n"
   ...
   fputs("              http:// instead.\n"
        ...
        , stdout);
   fputs("              parently be converted to HTTP. It means  that  certain  protocol\n"
        ...
        "\n"
        , stdout);
   fputs("              The  proxy host can be specified the exact same way as the proxy\n"
        ...
        "\n"
        , stdout);
   fputs("              The only difference between this and the HTTP proxy  option  -x,\n"
         ...
         , stdout);
   fputs("              lows direct connect to the remote port number curl wants to tun-\n"
         "              nel through to.\n"
         "\n"
   ...
   fputs("              If this option is used several times, the last one will be used.\n"
         ...
         "       -Q, --quote\n"
         , stdout);
   fputs("              (FTP SFTP) Send an arbitrary command to the remote FTP  or  SFTP\n"
        ...
        , stdout);
   fputs("              command(s), prefix the command with a '+'  (this  is  only  sup-\n"
        ...
        "\n"
        , stdout);
   fputs("              Prefix the command with an asterisk (*) to  make  curl  continue\n"
         ...
         , stdout);
   fputs("              acters.   Following is the list of all supported SFTP quote com-\n"
         "              mands:\n"
         "\n"
         "              chgrp group file\n"
         ...
         , stdout);
   fputs("                     specified file. The mode operand is an octal integer mode\n"
         "                     number.\n"
         "\n"
         "              chown user file\n"
         ...
         , stdout);
   fputs("                     target_file  location  pointing  to the source_file loca-\n"
         "                     tion.\n"
         "\n"
         ...
         , stdout);
   fputs("                     The rename command renames the file or directory named by\n"
         ...
         , stdout);
   fputs("                     by the directory operand, provided it is empty.\n"
        "\n"
        ...
        "       -r, --range <range>\n"
        , stdout);
   fputs("              (HTTP FTP SFTP FILE) Retrieve a byte range (i.e. a partial docu-\n"
         ...
         "\n"
         , stdout);
   fputs("              0-0,-1    specifies the first and last byte only(*)(HTTP)\n"
         "\n"
         "              100-199,500-599\n"
         ...
         , stdout);
   fputs("              ter is given in the range, the server's response will be unspec-\n"
         ...
         , stdout);
   fputs("              stop'  syntax  (optionally with one of the numbers omitted). FTP\n"
         ...
         "       -e, --referer <URL>\n"
         , stdout);
   fputs("              (HTTP) Sends the \"Referrer Page\" information to the HTTP server.\n"
   ...
   fputs("              If this option is used several times, the last one will be used.\n"
         ...
         , stdout);
   fputs("              already exists in the current working directory it will  not  be\n"
         ...
         , stdout);
   fputs("              Windows.  A  rogue  server  could  send you the name of a DLL or\n"
         ...
         , stdout);
   fputs("              all has been used, you must use \"-o -\" or --no-remote-name.\n"
         "\n"
         "              Added in 7.19.0.\n"
         "\n"
         "       -O, --remote-name\n"
         ...
         , stdout);
   fputs("              change the current working directory before invoking  curl  with\n"
         "              this option.\n"
         "\n"
         ...
         , stdout);
   fputs("              addition  to  this option. If the server chooses a file name and\n"
         ...
         "       -R, --remote-time\n"
         , stdout);
   fputs("              When  used,  this will make curl attempt to figure out the time-\n"
         ...
         , stdout);
   fputs("              other data that doesn't follow the  regular  URL  pattern,  like\n"
         "              \"OPTIONS *\".\n"
         "\n"
         "              Added in 7.55.0.\n"
         "\n"
         ...
         , stdout);
   fputs("              tions.  Common  additional HTTP requests include PUT and DELETE,\n"
         ...
         , stdout);
   fputs("              quest, it does not alter the way curl behaves. So for example if\n"
         ...
         , stdout);
   fputs("              method according to the HTTP 30x response codes - and similar.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("              (SMTP) Specifies a custom SMTP command to use instead of HELP or\n"
         ...
         , stdout);
   fputs("              used. Consider it a sort of /etc/hosts alternative  provided  on\n"
         ...
         , stdout);
   fputs("              and specific port pair to the specified address. Wildcard is re-\n"
         ...
         "\n"
         , stdout);
   fputs("              Support  for providing multiple IP addresses per entry was added\n"
         "              in 7.59.0.\n"
         "\n"
         ...
         , stdout);
   fputs("              option by default (eg in curlrc), there may be unintended conse-\n"
        ...
        , stdout);
   fputs("              flaky  transfers  as close as possible to how they were started,\n"
        ...
        , stdout);
   fputs("              via  redirect in combination with this option, since you may re-\n"
        ...
        "       --retry-delay <seconds>\n"
        , stdout);
   fputs("              Make curl sleep this amount of time before  each  retry  when  a\n"
   ...
   fputs("       --retry-max-time <seconds>\n"
         ...
         , stdout);
   fputs("              single request's maximum time, use -m, --max-time.  Set this op-\n"
         ...
         , stdout);
   fputs("              Setting the number to 0 makes curl do no retries (which  is  the\n"
         ...
         , stdout);
   fputs("              delay  between  the rest of the retries.  By using --retry-delay\n"
   ...
   fputs("              Added in 7.12.3.\n"
         ...
         , stdout);
   fputs("              server  implementation,  it may be used to access another user's\n"
         ...
         "\n"
         , stdout);
   fputs("              Examples:    --negotiate    --service-name   sockd   would   use\n"
         "              sockd/server-name.\n"
         "\n"
         "              Added in 7.43.0.\n"
         "       -S, --show-error\n"
         ...
         , stdout);
   fputs("              for, potentially even to the terminal/stdout unless you redirect\n"
         "              it.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("              This option overrides any previous use of -x, --proxy,  as  they\n"
         ...
         , stdout);
   fputs("              such a case curl first connects to the SOCKS proxy and then con-\n"
   ...
   fputs("              are mutually exclusive.\n"
         ...
         , stdout);
   fputs("              nects (through SOCKS) to the HTTP or HTTPS proxy.\n"
         "\n"
         "              If this option is used several times, the last one will be used.\n"
         "\n"
         "              Added in 7.18.0.\n"
   ...
   fputs("              Added in 7.55.0.\n"
         ...
         , stdout);
   fputs("              The default service name for a socks server is rcmd/server-fqdn.\n"
         ...
         "       --socks5-gssapi\n"
         , stdout);
   fputs("              Tells  curl  to  use GSS-API authentication when connecting to a\n"
         ...
         , stdout);
   fputs("              host  name).  If the port number is not specified, it is assumed\n"
         "              at port 1080.\n"
         "\n"
         "              This option overrides any previous use of -x, --proxy,  as  they\n"
         "              are mutually exclusive.\n"
         ...
         "              Since 7.52.0, --preproxy can be used to specify a SOCKS proxy at\n"
         , stdout);
   fputs("              the same time -x, --proxy is used with an HTTP/HTTPS  proxy.  In\n"
         "              such a case curl first connects to the SOCKS proxy and then con-\n"
         "              nects (through SOCKS) to the HTTP or HTTPS proxy.\n"
         "\n"
         "              If this option is used several times, the last one will be used.\n"
         ...
         , stdout);
   fputs("              cally.  If  the  port  number is not specified, it is assumed at\n"
         "              port 1080.\n"
         "\n"
         "              This option overrides any previous use of -x, --proxy,  as  they\n"
         "              are mutually exclusive.\n"
   ...
   fputs("              the  same  time -x, --proxy is used with an HTTP/HTTPS proxy. In\n"
         ...
         "       -Y, --speed-limit <speed>\n"
         , stdout);
   fputs("              If a download is slower than this given speed (in bytes per sec-\n"
         ...
         , stdout);
   fputs("              used, the default speed-limit will be  1  unless  set  with  -Y,\n"
         "              --speed-limit.\n"
         "\n"
         ...
         , stdout);
   fputs("              SSL3 and TLS1.0 protocols known as BEAST.  If this option  isn't\n"
         ...
         , stdout);
   fputs("              tion checks.  WARNING: this option loosens the SSL security, and\n"
         ...
         , stdout);
   fputs("              (Schannel)  This option tells curl to ignore certificate revoca-\n"
         ...
         , stdout);
   fputs("              ent levels of encryption required.\n"
         "\n"
         ...
         , stdout);
   fputs("              port. SSLv2 is widely considered insecure (see RFC 6176).\n"
         "\n"
         ...
         , stdout);
   fputs("              port. SSLv3 is widely considered insecure (see RFC 7568).\n"
         "\n"
   ...
   fputs("              If this option is used several times, the last one will be used.\n"
         ...
         , stdout);
   fputs("              don't output proxy CONNECT  response  headers.  This  option  is\n"
         ...
         "       --tcp-fastopen\n"
         , stdout);
   fputs("              Enable use of TCP Fast Open (RFC7413).\n"
         "\n"
         "              Added in 7.49.0.\n"
         "\n"
         "       --tcp-nodelay\n"
         ...
         , stdout);
   fputs("              Pass options to the telnet protocol. Supported options are:\n"
         "\n"
         ...
         , stdout);
   fputs("              a TFTP server. By default 512 bytes will be used.\n"
         "\n"
         "              If this option is used several times, the last one will be used.\n"
         "\n"
         "              Added in 7.20.0.\n"
   ...
   fputs("              Added in 7.48.0.\n"
         ...
         , stdout);
   fputs("              stead. See the curl_getdate(3) man pages for date expression de-\n"
         "              tails.\n"
         "\n"
         ...
         "       --tls-max <VERSION>\n"
         , stdout);
   fputs("              (SSL) VERSION defines maximum supported TLS version. The minimum\n"
         ...
         "\n"
         , stdout);
   fputs("       See also --tlsv1.0 and --tlsv1.1 and --tlsv1.2 and --tlsv1.3. --tls-max\n"
         ...
         "\n"
         , stdout);
   fputs("               https://curl.haxx.se/docs/ssl-ciphers.html\n"
         "\n"
         "              This option is currently used only when curl  is  built  to  use\n"
         "              OpenSSL 1.1.1 or later. If you are using a different SSL backend\n"
         ...
         "       --tlsauthtype <type>\n"
         , stdout);
   fputs("              Set  TLS  authentication type. Currently, the only supported op-\n"
   ...
   fputs("       --tlspassword\n"
         ...
         "\n"
         , stdout);
   fputs("              This doesn't work with TLS 1.3.\n"
         "\n"
         "              Added in 7.21.4.\n"
         "\n"
         "       --tlsv1.0\n"
   ...
   fputs("              Added in 7.34.0.\n"
         ...
         "       --tlsv1.2\n"
         , stdout);
   fputs("              (TLS)  Forces curl to use TLS version 1.2 or later when connect-\n"
         "              ing to a remote TLS server.\n"
         "\n"
         "              In old versions of curl this  option  was  documented  to  allow\n"
         ...
         "       --tlsv1.3\n"
         , stdout);
   fputs("              (TLS)  Forces curl to use TLS version 1.3 or later when connect-\n"
         "              ing to a remote TLS server.\n"
         "\n"
         ...
         , stdout);
   fputs("              ing  with  a  remote  TLS  server. That means TLS version 1.0 or\n"
         "              higher\n"
         "\n"
   ...
   fputs("              receiving it.\n"
         ...
         , stdout);
   fputs("              that might be easier to read for untrained humans.\n"
         "\n"
         "              If this option is used several times, the last one will be used.\n"
         "\n"
         ...
         "              Enables a full trace dump of all incoming and outgoing data, in-\n"
         , stdout);
   fputs("              cluding descriptive information, to the given output  file.  Use\n"
   ...
   fputs("              the network.\n"
         ...
         , stdout);
   fputs("              name to use. That will most likely cause the upload operation to\n"
   ...
   fputs("              loaded.\n"
         ...
         "\n"
         , stdout);
   fputs("               curl --upload-file \"{file1,file2}\" http://www.example.com\n"
         "\n"
         "              or even\n"
         "\n"
         ...
         "       --url <url>\n"
         , stdout);
   fputs("              Specify a URL to fetch. This option is  mostly  handy  when  you\n"
         ...
         , stdout);
   fputs("              will be used. Since 7.45.0 guessing can be disabled by setting a\n"
   ...
   fputs("       -B, --use-ascii\n"
         ...
         , stdout);
   fputs("              quote  marks.  This header can also be set with the -H, --header\n"
         ...
         , stdout);
   fputs("              Specify the user name and password to use for server authentica-\n"
         ...
         "\n"
         , stdout);
   fputs("              On systems where it works, curl will hide the given option argu-\n"
         "              ment  from  process listings. This is not enough to protect cre-\n"
         "              dentials from possibly getting seen by other users on  the  same\n"
         "              system  as  they will still be visible for a brief moment before\n"
         ...
         "              stead or similar and never used in clear text in a command line.\n"
         , stdout);
   fputs("              When  using  Kerberos  V5 with a Windows based server you should\n"
   ...
   fputs("              forest in your setup for example.\n"
         ...
         , stdout);
   fputs("              ronment by specifying a single colon with this option: \"-u :\".\n"
         "\n"
         "              If this option is used several times, the last one will be used.\n"
         "\n"
         "       -v, --verbose\n"
   ...
   fputs("              --trace-ascii.\n"
         ...
         , stdout);
   fputs("              libcurl reports to offer. Available features include:\n"
         "\n"
         "              alt-svc\n"
   ...
   fputs("                     supported.\n"
         ...
         "\n"
         , stdout);
   fputs("              SPNEGO SPNEGO authentication is supported.\n"
         "\n"
         ...
         "       -w, --write-out <format>\n"
         , stdout);
   fputs("              Make curl display information on stdout after a completed trans-\n"
         ...
         "\n"
         , stdout);
   fputs("              The  variables  present in the output format will be substituted\n"
         ...
         , stdout);
   fputs("              switched to standard error by using %{stderr}.\n"
         "\n"
         ...
         "              filename_effective\n"
         , stdout);
   fputs("                             The  ultimate  filename  that curl writes out to.\n"
         ...
         "\n"
         , stdout);
   fputs("              ftp_entry_path The initial path curl ended up in when logging on\n"
         ...
         "\n"
         , stdout);
   fputs("              http_connect   The numerical code that was found in the last re-\n"
         ...
         , stdout);
   fputs("                             cently done connection - can be  either  IPv4  or\n"
   ...
   fputs("                             quest. (Added in 7.12.3)\n"
         ...
         , stdout);
   fputs("                             met), this variable will show the  actual  URL  a\n"
         ...
         "\n"
         , stdout);
   fputs("              response_code  The numerical response code that was found in the\n"
         ...
         "\n"
         , stdout);
   fputs("              size_header    The total amount of bytes of the downloaded head-\n"
         "                             ers.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("              speed_upload   The average upload speed that curl  measured  for\n"
         ...
         , stdout);
   fputs("                             will be written  to  standard  error.  (Added  in\n"
         "                             7.63.0)\n"
         "\n"
         ...
         "              time_appconnect\n"
         , stdout);
   fputs("                             The time, in seconds, it took from the start  un-\n"
   ...
   fputs("                             tion lasted.\n"
         ...
         , stdout);
   fputs("              the URL is stored in the xdg.origin.url attribute and, for HTTP,\n"
         ...
         , stdout);
   fputs("       The lower case version has precedence. http_proxy is an exception as it\n"
         ...
         , stdout);
   fputs("              Sets  the proxy server to use for [url-protocol], where the pro-\n"
         ...
         , stdout);
   fputs("              to an asterisk '*' only, it matches all hosts. Each name in this\n"
         ...
         , stdout);
   fputs("              rect.example.com  accesses  the   target   URL   directly,   and\n"
         ...
         , stdout);
   fputs("              If  curl  was built with support for \"MultiSSL\", meaning that it\n"
         ...
         , stdout);
   fputs("              If curl was built with HTTP/3 support, setting this  environment\n"
         ...
         , stdout);
   fputs("              store TLS secrets from its connections in that file when invoked\n"
         ...
         , stdout);
   fputs("       protocol:// prefix to specify alternative proxy protocols.\n"
         "\n"
   ...
   fputs("       socks4://\n"
         ...
         "\n"
         , stdout);
   fputs("       1      Unsupported protocol. This build of curl has no support for this\n"
         "              protocol.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("       5      Couldn't  resolve  proxy.  The given proxy host could not be re-\n"
         "              solved.\n"
         "\n"
         ...
         , stdout);
   fputs("              often you tried to change to a directory that doesn't  exist  on\n"
         "              the server.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("       12     During an active FTP session while waiting  for  the  server  to\n"
        ...
        "\n"
        , stdout);
   fputs("       16     HTTP/2 error. A problem was detected in the HTTP2 framing layer.\n"
        ...
        "\n"
        , stdout);
   fputs("       21     FTP quote error. A quote command returned error from the server.\n"
   ...
   fputs("              used for FTP uploading.\n"
         ...
         "\n"
         , stdout);
   fputs("       31     FTP  couldn't use REST. The REST command failed. This command is\n"
         ...
         "\n"
         , stdout);
   fputs("       37     FILE couldn't read file. Failed to open the file. Permissions?\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("       45     Interface error. A specified outgoing  interface  could  not  be\n"
         "              used.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("       51     The peer's SSL certificate or SSH MD5 fingerprint was not OK.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("       60     Peer  certificate cannot be authenticated with known CA certifi-\n"
         "              cates.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("       68     File not found on TFTP server.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("       78     The resource referenced in the URL does not exist.\n"
         "\n"
         ...
         "\n"
         , stdout);
   fputs("       87     unable to parse FTP file list\n"
         "\n"
         ...
         , stdout);
   fputs("       Daniel  Stenberg is the main author, but the whole list of contributors\n"
