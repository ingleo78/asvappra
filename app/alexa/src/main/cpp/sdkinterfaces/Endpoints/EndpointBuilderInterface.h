        ...
        namespace sdkInterfaces {
            namespace endpoints {
                ...
                public:
                    ...
                    virtual EndpointBuilderInterface& withDisplayCategory(const vector<string>& displayCategories);
                    ...
                    virtual EndpointBuilderInterface& withPowerController(shared_ptr<PowerControllerInterface> powerController, bool isProactivelyReported,
                                                                          bool isRetrievable);
                    ...
                    virtual EndpointBuilderInterface& withModeController(shared_ptr<ModeControllerInterface> modeController, const std::string& instance,
